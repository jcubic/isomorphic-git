...
export async function readObject ({
  ...
  if (format === 'parsed') {
    switch (result.type) {
      ...
      case 'tag':
        throw new Error(
          'readObject.js:34 E102 TODO: Parsing annotated tag objects still needs to be implemented!!'
        )
      default:
        throw new Error(`readObject.js:37 E103 Unrecognized git object type: '${result.type}'`)
    }
